const SETTINGS_FIELDS = [
  ...
  { k: 'race_timeout', label: '首包等待超时（秒）', type: 'number', max: 1800, min: 0, group: 'pool', desc: '候选等待首个合法上游包的最大时间（0 = 不单独限制，默认 60 秒）' },
  ...
  { k: 'recaptcha_try_entry_or_direct', label: '优先前置/直连抓取 rT', type: 'checkbox', group: 'pool', desc: '优先通过入口代理或服务器直连获取 recaptcha token，失败后回退请求节点。' },
