...
const LOADERS = { overview: loadOverview, analytics: loadAnalytics, settings: loadSettings, keys: loadKeys, models: loadModels, nodes: loadNodes, subscriptions: loadSubscriptions, appearance: loadAppearance, logs: loadLogs };
const PAGE_CACHE = {};
let curPage = null;
