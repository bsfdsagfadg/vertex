const API = {
  ...
  proxyNodes: {
    list() { return API.raw('/api/admin/proxy-nodes'); },
    import(uri) { return API.raw('/api/admin/proxy-nodes/import', { method: 'POST', body: JSON.stringify({ raw_uri: uri }) }); },
    toggle(uris, disabled) { return API.raw('/api/admin/proxy-nodes/toggle', { method: 'POST', body: JSON.stringify({ uris, disabled }) }); },
