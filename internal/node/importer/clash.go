...
func ParseClashYAMLToNodes(yamlText string) []exitpool.Node {
...
func parseStructuredClashYAMLNodes(yamlText string) []exitpool.Node {
	var doc struct {
...
func parseInlineClashYAMLNodes(yamlText string) []exitpool.Node {
...
func buildClashNodes(proxies []map[string]any) []exitpool.Node {
	imported := make([]exitpool.Node, 0, len(proxies))
...
func buildClashNode(proxy map[string]any) (exitpool.Node, bool) {
